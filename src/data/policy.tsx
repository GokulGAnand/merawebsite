const policy = [
  {
    ...
    content: `Last updated: April 11, 2024 <br/>  <br/>
  ...
  },
  {
    ...
    content: `<strong>Interpretation</strong> <br/> 
      ...
      <strong>Account</strong> mean a unique account created for You to access our Service or parts of our Service. <br /> <br/>

      <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Team Tech Media, 0, 71/232, Puthiyamadam Parambil, Athanikkal, Puthiyangadi, Kozhikode, Kerala. <br/> <br/>
      ...
      <strong>Country</strong> refers to: India <br/> <br/>

      <strong>Device</strong> means any device that can access the Service such as a computer, a cell phone,  or a digital tablet. <br/> <br/>
      ...
      <strong>Website</strong> refers to MeraCars, accessible from <a href='https://www.meracars.com/' >https://www.meracars.com/</a>  </br> </br>
  ...
  },
  {
    ...
    content: `<strong>Types of Data Collected</strong> <br/> <br/>
...
`,
  },
  {
    ...
    <strong>To provide and maintain our Service</strong>, including monitoring the usage of our Service. <br/>
    ...
    <strong>To provide You</strong> with news, special offers, and general information about other goods, services, and events that we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information. <br/> <br/>
    ...
    <strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns, and evaluating and improving our Service, products, services, marketing, and your experience. <br/> <br/>
    We may share Your personal information in the following situations: <br/>  <br/> 
    
    
    <strong>• With Service Providers</strong>: We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You. <br/>
    <strong>• For business transfers</strong>: We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company. <br/>
    ...
    <strong>• With business partners</strong>: We may share Your information with Our business partners to offer You certain products, services, or promotions. <br/>
    <strong>• With other users</strong>: When you share personal information or otherwise interact in public areas with other users, such information may be viewed by all users and may be publicly distributed outside. <br/>
    <strong>• With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent. <br/>
  ...
  },
  {
    ...
    content: `You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You. <br/> <br/>
  ...
  },
  {
    ...
    content: `<strong>Business Transactions</strong> <br/> 
     If the Company is involved in a merger, acquisition, or asset sale, Your Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy. <br/> <br/>
     <strong>Law enforcement</strong> <br/>
     Under certain circumstances, the Company may be required to disclose Your Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency). <br/> <br/>
     <strong>Other legal requirements</strong> <br/>
     The Company may disclose Your Data in the good faith belief that such action is necessary to: <br/> 
 ...
 `,
  },
  {
    ...
    content: `The security of Your Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Data, We cannot guarantee its absolute security.`,
  },
  {
    id: 11,
    title: `Children's Privacy`,
    content: `Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. Suppose We become aware that We have collected Personal Data from anyone under the age of 13 without verification of parental consent. In that case, We take steps to remove that information from Our servers. <br/>
<br/> If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.    `,
  },
  {
    ...
    content: `Our Service may contain links to other websites that we do not operate. If You click on a third-party link, You will be directed to that third-party site. We strongly advise You to review the Privacy Policy of every site You visit. <br/>
  ...
  },
  {
    ...
    content: `We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page. <br/> <br/>

        We will let You know via email and/or a prominent notice on Our Service, before the change becomes effective and update the "Last updated" date at the top of this Privacy Policy. <br/>
  ...
  },
  {
    id: 14,
    title: 'Contact Us',
    content: `If you have any questions about this Privacy Policy, You can contact us: <br/>
            By email: office@teamtechmedia.com
             `,
  },
];
